...
- **Post-Implementation Risk Review:** After writing code, always list what could break and suggest tests that cover each identified risk.
- **Correction Memory Rule:** Every time I correct you, add a new rule to this `AGENTS.md` file so the same mistake is prevented in future runs.
